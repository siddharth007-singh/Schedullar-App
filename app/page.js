    ...
    <main className="container mx-auto px-4 py-16">
      <div className="flex flex-col lg:flex-row justify-between items-center gap-12 mb-24">
        <div className="lg:w-1/2">
          ...
          <p className="text-xl text-gray-600 mb-10">Lorem ipsum, or lipsum as it is sometimes known,
          is dummy text used in laying out print, graphic or web designs</p>

          <Link href="/dashboard"><Button size={"lg"} className={"text-lg"}>Get Started <ArrowRight className="ml-2 h-5 w-5 cursor-pointer"/></Button></Link>
        </div>

        <div className="lg:w-1/2 flex justify-center">
          <div className="relative w-full mx-w-md aspect-square">
            <Image src="/poster.png" layout="fill" alt="hero" objectFit="contain" />
          </div>
        </div>
      </div>
